...
from wagtail.collectors import (
    ModelRichTextCollector,
    ModelStreamFieldsCollector,
    Use,
    get_all_uses,
)
...
class ModelRichTextCollectorTest(TestCase):
    def setUp(self):
        ...
        def create_page(body):
            ...
            page = DefaultRichTextFieldPage(title="%s" % i, body=body, slug="%s" % i)
        ...
        self.obj2 = create_page('<a linktype="page" id="%s">1</a>' % self.obj1.pk)
        self.obj3 = create_page(
            '<p><a id="%s" linktype="page">2</a></p>' % self.obj2.pk
        )
        self.obj4 = create_page(
            '<p>A link to the <a linktype="page" id="%s">3</a> page.</p>' % self.obj3.pk
        )
        self.obj5 = create_page(
            "<div><p>A link <span>to the "
            '<a linktype="page" id="%s">4</a></span> page.</p><div>' % self.obj4.pk
        )
        self.obj6 = create_page("<p>Nothing interesting here</p>")
        self.obj7 = create_page(
            '<p><a linktype="page" id="%s">5</a>'
            '<a linktype="page" id="%s">6</a></p>' % (self.obj5.pk, self.obj6.pk)
        )
        self.image = Image.objects.create(
            title="Test image", file=get_test_image_file()
        )
        self.obj8 = create_page(
            '<embed alt="bodyline" embedtype="image" '
        ...
        self.obj9 = create_page(
            '<a id="%s" linktype="document">Test document</a>' % self.document.pk
        )
        self.video = get_embed("https://www.youtube.com/watch?v=6adGK7fXZX8")
        self.obj10 = create_page('<embed embedtype="media" url="%s"/>' % self.video.url)
    ...
    def test_multiple(self):
        ...
        with self.assertNumQueries(5):
            ...
            self.assertListEqual(
                pairs, [(self.obj7, self.obj5), (self.obj7, self.obj6)]
            )
...
class ModelStreamFieldCollectorTest(TestCase):
    def setUp(self):
        ...
        self.image0 = Image.objects.create(
            title="Test image 0", file=get_test_image_file()
        )
        ...
        self.image4 = Image.objects.create(
            title="Test image 4", file=get_test_image_file()
        )
        self.image5 = Image.objects.create(
            title="Test image 5", file=get_test_image_file()
        )
        self.image6 = Image.objects.create(
            title="Test image 6", file=get_test_image_file()
        )
        self.image7 = Image.objects.create(
            title="Test image 7", file=get_test_image_file()
        )
        self.image8 = Image.objects.create(
            title="Test image 8", file=get_test_image_file()
        )
        self.image9 = Image.objects.create(
            title="Test image 9", file=get_test_image_file()
        )
        self.image10 = Image.objects.create(
            title="Test image 10", file=get_test_image_file()
        )
        self.image11 = Image.objects.create(
            title="Test image 11", file=get_test_image_file()
        )
        self.image12 = Image.objects.create(
            title="Test image 12", file=get_test_image_file()
        )

        self.obj_empty = StreamModel.objects.create()
        self.obj_text = StreamModel.objects.create(body=[("text", "foo")])
        self.obj1 = StreamModel.objects.create(body=[("image", self.image1)])
        self.obj2 = StreamModel.objects.create(
            body=[("text", "foo"), ("image", self.image2), ("text", "bar")]
        )
        self.obj3 = StreamModel.objects.create(
            body=[("struct", {"image": self.image3})]
        )
        self.obj4 = StreamModel.objects.create(
            body=[("struct", {"image_list": [self.image4]})]
        )
        self.obj5 = StreamModel.objects.create(
            body=[("struct", {"struct_list": [{"image": self.image5}]})]
        )
        self.obj6 = StreamModel.objects.create(
            body=[
                ("text", "foo"),
                ("image", self.image6),
                (
        ...
        self.obj7 = StreamModel.objects.create(body=[("image", self.image9)])
        self.obj8 = StreamModel.objects.create(
            body=[("struct", {"image": self.image8})]
        )
        self.obj9 = StreamModel.objects.create(
            body=[("struct", {"image_list": [self.image7]})]
        )
        self.obj10 = StreamModel.objects.create(
            body=[("struct", {"struct_list": [{"image": self.image6}]})]
        )
        self.obj11 = StreamModel.objects.create(
            body=[
                (
                    "rich_text",
                    RichText(
    ...
    def get_image_pairs(self, *images):
        return list(
            self.collector.find_objects(*images, block_types=(ImageChooserBlock,))
        )
    ...
    def test_nested_stream(self):
        ...
        self.assertListEqual(
            pairs, [(self.obj12, self.image12), (self.obj13, self.image12)]
        )
    ...
    def test_multiple(self):
        with self.assertNumQueries(6):
            ...
            self.assertListEqual(
                pairs, [(self.obj6, self.image6), (self.obj10, self.image6)]
            )
        with self.assertNumQueries(6):
            pairs = self.get_image_pairs(self.image7)
            self.assertListEqual(
                pairs, [(self.obj6, self.image7), (self.obj9, self.image7)]
            )
        with self.assertNumQueries(6):
            pairs = self.get_image_pairs(self.image8)
            self.assertListEqual(
                pairs, [(self.obj6, self.image8), (self.obj8, self.image8)]
            )
        with self.assertNumQueries(6):
            pairs = self.get_image_pairs(self.image9)
            self.assertListEqual(
                pairs, [(self.obj6, self.image9), (self.obj7, self.image9)]
            )
...
class GetAllUsesTest(TestCase):
    def setUp(self):
        ...
        self.obj4 = create_page(
            '<p><a linktype="page" id="%s">3</a></p>' % self.obj3.pk
        )
        self.obj5 = Image.objects.create(
            title="Test image 1", file=get_test_image_file()
        )
        self.obj6 = StreamModel.objects.create(body=[("image", self.obj5)])
        self.obj7 = Image.objects.create(title="Test image", file=get_test_image_file())
    ...
    def test_empty(self):
        with self.assertNumQueries(
            60 if self.has_postgres_search else (59 if self.is_postgres else 58)
        ):
    ...
    def test_foreign_key(self):
        with self.assertNumQueries(
            60 if self.has_postgres_search else (59 if self.is_sqlite else 58)
        ):
    ...
    def test_multiple(self):
        with self.assertNumQueries(
            53 if self.has_postgres_search or self.is_sqlite else 52
        ):
